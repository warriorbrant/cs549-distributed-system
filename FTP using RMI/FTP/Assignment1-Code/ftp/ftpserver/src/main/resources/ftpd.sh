...
echo "java -Djava.security.policy=$POLICY -Djava.rmi.server.hostname=$SERVERHOST -jar $JARFILE"
java -Djava.security.policy=$POLICY -Djava.rmi.server.hostname=$SERVERHOST -jar $JARFILE
