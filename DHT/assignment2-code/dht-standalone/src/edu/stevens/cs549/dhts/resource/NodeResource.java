...
public class NodeResource {
	...
	@Path("closest")
	@Produces("application/xml")
	public Response getClosest(@QueryParam("id") int id) {
		return new NodeService(headers, uriInfo).getClosest(id);
	}
	...
	@GET
	@Produces("application/xml")
	public Response findK(@QueryParam("key") String key) {
		return new NodeService(headers, uriInfo).findK(key);
	}
	
	@PUT
	public void setKeyValue(@QueryParam("key") String key, @QueryParam("val") String value) {
		new NodeService(headers, uriInfo).setKeyValue(key, value);
	}
	
	@DELETE
	public void deleteKey(@QueryParam("key") String key, @QueryParam("val") String value) {
